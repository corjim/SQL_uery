...
SELECT app_name, id FROM analytics WHERE last_updated = ('August 01, 2018');
...
SELECT * FROM analytics WHERE rating > 4.8 ORDER
 BY reviews;
...
SELECT app_name, price, rating FROM analytics WHERE rating < 3 ORDER BY price LIMIT 3;
